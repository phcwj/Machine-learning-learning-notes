...
![iwYPmR.png](img/20240114171232.png)

基于上述变量之间的依赖关系，我们很容易写出隐马尔可夫模型中所有变量的联合概率分布：

![iwY9X9.png](img/20240114171246.png)

易知：**欲确定一个HMM模型需要以下三组参数**：

![iwYi01.png](img/20240114171259.png)

当确定了一个HMM模型的三个参数后，便按照下面的规则来生成观测值序列：

![iwYFTx.png](img/20240114171313.png)

在实际应用中，HMM模型的发力点主要体现在下述三个问题上：

![iwYEtK.png](img/20240114171328.png)
...
![iwYVfO.png](img/20240114171343.png)

基于前向变量，很容易得到该问题的递推关系及终止条件：

![iwYAk6.png](img/20240114171357.png)
...
![iwYepD.png](img/20240114171413.png)
...
![iwYm1e.png](img/20240114171430.png)
...
![iwYn6H.png](img/20240114171445.png)
![iwYdns.png](img/20240114171501.png)

【3】接着便可以对模型的三个参数进行重新估计：

![iwYY9S.png](img/20240114171516.png)
...
![iwYGh8.png](img/20240114171536.png)
...
![iwYUXj.png](img/20240114171703.png)

![iwYwBn.png](img/20240114171723.png)

###**15.4.2 信念传播**

若将变量求和操作看作是一种消息的传递过程，信念传播可以理解成：**一个节点在接收到所有其它节点的消息后才向另一个节点发送消息**，同时当前节点的边际概率正比于他所接收的消息的乘积：

![iwYDA0.png](img/20240114171739.png)
...
![iwYgc4.png](img/20240114171754.png)
...
![iwY2jJ.png](img/20240114171811.png)
...
![iwYc3F.png](img/20240114171828.png)
![iwYWu9.png](img/20240114171844.png)
