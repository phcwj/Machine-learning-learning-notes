...
![3.png](img/20240114161622.png)

而超平面（w,b）关于所有样本点（Xi，Yi）的函数间隔最小值则为超平面在训练数据集T上的函数间隔：

![4.png](img/20240114161637.png)
...
![5.png](img/20240114161656.png)

为了得到r的绝对值，令r呈上其对应的类别y，即可得到几何间隔的定义：

![6.png](img/20240114161714.png)
...
![20.png](img/20240114162151.png)

按照同样的方法，先写出新目标函数的拉格朗日函数，接着写出其对偶问题，求L关于w和b的极大，最后运用SOM求解α。可以得出：

（1）原对偶问题变为：

![21.png](img/20240114162226.png)

（2）原分类函数变为：
​    ![22.png](img/20240114162245.png)
