...
![1.png](img/20240114155440.png)

![2.png](img/20240114155459.png)

![3.png](img/20240114155518.png)

###**2.6.2 交叉验证t检验**

![4.png](img/20240114155535.png)
...
![7.png](img/20240114155633.png)

若学习器的性能相同，则它们的平均序值应该相同，且第i个算法的平均序值ri服从正态分布N（（k+1）/2，（k+1）(k-1)/12），则有：

![8.png](img/20240114155656.png)

![9.png](img/20240114155716.png)

服从自由度为k-1和(k-1)(N-1)的F分布。下面是F检验常用的临界值：

![10.png](img/20240114155739.png)
...
![11.png](img/20240114155756.png)

![12.png](img/20240114155814.png)
