...
![7.png](img/20240114165531.png)

接着使用拉格朗日乘子法求解上面的优化问题，得到：

![8.png](img/20240114165547.png)

因此只需对协方差矩阵进行特征值分解即可求解出W，PCA算法的整个流程如下图所示：

![9.png](img/20240114165603.png)
...
![10.png](img/20240114165628.png)

这样我们便可以将高维特征空间中的投影向量wi使用所有高维样本点线性表出，接着代入PCA的求解问题，得到：

![11.png](img/20240114165643.png)
...
![21.png](img/20240114165907.png)

若各个属性重要程度不一样即都有一个权重，则得到加权的平方欧式距离：

![22.png](img/20240114165929.png)
...
![23.png](img/20240114165951.png)

**标准的马氏距离中M是协方差矩阵的逆，马氏距离是一种考虑属性之间相关性且尺度无关（即无须去量纲）的距离度量**。

![24.png](img/20240114170009.png)
